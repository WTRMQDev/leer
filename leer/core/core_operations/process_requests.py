...
def process_blocks_request(message, send_message, storage_space, rtx):
  num = message["num"]
...
def process_next_headers_request(message, send_message, storage_space, rtx):
...
def process_txos_request(message, send_message, storage_space, rtx):
  num = message["num"]
...
def  process_tbm_tx_request(message, send_message, storage_space, rtx):
