...
def init_database(cursor):
  ...
  cursor.execute("CREATE TABLE outputs (id integer PRIMARY KEY AUTOINCREMENT, output text KEY, value int, lock_height int, created_height int KEY, spent_height int KEY,  ser_blinding_key text, ser_apc int, taddress text KEY, spent boolean)")
