...
def init_database(cursor):
  ...
  cursor.execute("CREATE TABLE outputs (id integer PRIMARY KEY AUTOINCREMENT, output text KEY, value text, lock_height text, created_height text KEY, spent_height text KEY, ser_blinding_key text, ser_apc text, taddress text KEY, spent boolean)")
